...
```lua
local Library = loadstring(game:GetService("HttpService"):GetAsync("https://github.com/joustingmatch/Fluent-Ultra/releases/latest/download/Fluent.luau", true))()
```

```lua
local Library = loadstring(game:HttpGetAsync("https://github.com/joustingmatch/Fluent-Ultra/releases/latest/download/Fluent.luau", true))()
```
